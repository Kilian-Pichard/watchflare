...
-- =====================================================
-- Current Package State (one row per package per host)
-- =====================================================
CREATE TABLE IF NOT EXISTS packages (
    ...
    -- Composite unique constraint: one version per package per host
    CONSTRAINT packages_host_name_unique UNIQUE (host_id, name, package_manager)
);
...
CREATE INDEX IF NOT EXISTS idx_package_history_host_time ON package_history(host_id, timestamp DESC);
...
CREATE INDEX IF NOT EXISTS idx_package_collections_host_time ON package_collections(host_id, timestamp DESC);
