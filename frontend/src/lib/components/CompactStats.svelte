...
>
    ...
    <div class="flex items-center gap-3">
        <div
            class="flex h-9 w-9 items-center justify-center rounded-lg bg-chart-1/10"
        >
            <svg
                class="h-5 w-5 text-chart-1"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
            >
    ...
    <div class="flex items-center gap-3">
        <div
            class="flex h-9 w-9 items-center justify-center rounded-lg bg-chart-2/10"
        >
            <svg
    ...
    <div class="flex items-center gap-3">
        <div
            class="flex h-9 w-9 items-center justify-center rounded-lg bg-chart-3/10"
        >
            <svg
                class="h-5 w-5 text-chart-3"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
            >
